import 'package:diary_app/car_widget.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:diary_app/constants.dart';
import 'package:diary_app/data.dart';
import 'package:diary_app/book_car.dart';
...
class _AvailableCarsState extends State<AvailableCars> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Available Trucks (" + getCarList().length.toString() + ")",
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 36,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<Filter>('selectedFilter', selectedFilter));
  }
}